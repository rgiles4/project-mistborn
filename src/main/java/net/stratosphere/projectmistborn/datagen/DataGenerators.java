...
@Mod.EventBusSubscriber(modid = ProjectMistborn.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeClient(), new ModBlocksStatesProvider(packOutput, existingFileHelper));
